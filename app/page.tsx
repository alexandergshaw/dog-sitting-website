...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left">
              ...
              {/* Stats */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8 text-white/90 text-sm">
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                  </svg>
                  <span className="font-semibold">{stats.total_dogs}+ Dogs</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">{stats.years_experience}+ Years</span>
                </div>
                <div className="w-px h-4 bg-white/30"></div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="font-semibold">{stats.repeat_clients} Repeats</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <a
                  href="/contact"
                  className="group w-full sm:w-auto px-8 py-4 bg-white text-blue-600 text-lg font-bold rounded-2xl shadow-2xl hover:shadow-white/20 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
                ...
                <a
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-transparent text-white border-2 border-white/30 backdrop-blur-sm text-lg font-bold rounded-2xl hover:bg-white/10 hover:border-white/50 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
